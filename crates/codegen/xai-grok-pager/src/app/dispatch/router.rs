...
use super::settings::setters::{
    ...
    save_custom_api_config, set_combine_queued_prompts, set_compact_mode,
    ...
    set_custom_model_fetch_models, set_custom_model_selected, set_default_model,
    set_default_selected_permission, set_display_refresh_auto_cadence,
